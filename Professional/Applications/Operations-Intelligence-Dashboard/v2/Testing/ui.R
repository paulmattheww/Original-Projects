...
dashboardPage(skin='red',
              ...
              dashboardSidebar(width=350,
                               sidebarMenu(
                                 ...
                                 menuItem('Velocity', tabName='velocity', icon=icon('wrench'),  #'flag-checkered'),
                                 ...
                                 menuItem('Man Hours', tabName='man_hours', icon=icon('wrench'),
                                          menuSubItem('Labor Summary', tabName='labor_summary'),
                                          menuSubItem('Time Series', tabName='labor_time_series'),
                                          menuSubItem('Atomic Level, This Year', tabName='labor_atomic'),
                                          menuSubItem('Atomic Level, Last Year', tabName='labor_atomic_ly')),
                                 
                                 menuItem('Returns', tabName='returns', icon=icon('wrench')),
                                 
                                 menuItem('Inventory', tabName='inventory', icon=icon('wrench'),
                                          menuSubItem('Adjustments', tabName='inventory_adjustments'),
                                          menuSubItem('Out of Stocks', tabName='inventory_oos'),
                                          menuSubItem('Receipts', tabName='inventory_receipts')),
                                 
                                 menuItem('Plots', tabName='plots', icon=icon('wrench')),
