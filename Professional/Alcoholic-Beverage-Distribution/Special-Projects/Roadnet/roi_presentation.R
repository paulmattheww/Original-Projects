...
non_recurring_inflator = 1 # IT WILL PROBABLY GO OVER BUDGET AND TIMELINE
...
p_truck_gone = 0.95 # probability of ACTUALLY getting truck off road
...
percent_saved_driver_compensation = 0.02
...
png(file='C:/Users/pmwash/Desktop/Roadnet Implementation/ROI Analysis/Images/mid3_cost_benefit_2pct_fuel_2pct_comp_50pct_over.png', width=766, height=545)
...
g + geom_point(aes(group=Year)) + 
  ...
  ggtitle(expression(atop('Middle-of-the-Road Scenario: Accumulated Costs vs. Accumulated Savings of Roadnet', 
                     atop(italic('Assuming 2% Savings in Drivers Compensation & 2% Savings in Fuel Expenses & 95% Probability We Can Get Truck Off Road & Implementation Fees 0% Over'))))) +
  labs(y='Dollars')
dev.off()
