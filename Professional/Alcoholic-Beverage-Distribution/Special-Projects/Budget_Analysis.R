...
march1$DATE <- as.character(strptime(file_list[1], "%m-%d")) 
...
april1$DATE <- as.character(strptime(file_list[1], "%m-%d")) 
...
# append the months below to file from above
print("THIS PART IS FOR september 2015")
path <- "//majorbrands.com/STLcommon/Daily Report/2015/SEPT"
setwd(path)
...
september18 <- readWorksheetFromFile(file_list[18], sheet=2, startCol=3)

september1$DATE <- as.character(strptime(file_list[1], "%m-%d")) 
september2$DATE <- as.character(strptime(file_list[2], "%m-%d")) 
september3$DATE <- as.character(strptime(file_list[3], "%m-%d")) 
september4$DATE <- as.character(strptime(file_list[4], "%m-%d")) 
september5$DATE <- as.character(strptime(file_list[5], "%m-%d")) 
september6$DATE <- as.character(strptime(file_list[6], "%m-%d")) 
september7$DATE <- as.character(strptime(file_list[7], "%m-%d")) 
september8$DATE <- as.character(strptime(file_list[8], "%m-%d")) 
september9$DATE <- as.character(strptime(file_list[9], "%m-%d")) 
september10$DATE <- as.character(strptime(file_list[10], "%m-%d")) 
september11$DATE <- as.character(strptime(file_list[11], "%m-%d")) 
september12$DATE <- as.character(strptime(file_list[12], "%m-%d")) 
september13$DATE <- as.character(strptime(file_list[13], "%m-%d")) 
september14$DATE <- as.character(strptime(file_list[14], "%m-%d")) 
september15$DATE <- as.character(strptime(file_list[15], "%m-%d")) 
september16$DATE <- as.character(strptime(file_list[16], "%m-%d")) 
september17$DATE <- as.character(strptime(file_list[17], "%m-%d")) 
september18$DATE <- as.character(strptime(file_list[18], "%m-%d")) 



september2015 <- rbind(september1, september2, september3, september4, september5, 
                    september6, september7, september8, september9, september10, 
                    september11, september12, september13, september14, september15, september16, 
                    september17, september18)
september2015 <- filter(september2015, Driver != "Totals:")
rm(september1, september2, september3, september4, september5, 
   september6, september7, september8, september9, september10, 
   september11, september12, september13, september14, september15, september16, september17, september18)
#View(september2015)
...
# append the months below to file from above
print("THIS PART IS FOR october 2015")
path <- "//majorbrands.com/STLcommon/Daily Report/2015/OCT"
setwd(path)


file_list <- list.files() 
file_list <- file_list[2:20]
length(file_list)
file_list
...
october1$DATE <- as.character(strptime(file_list[1], "%m-%d")) 
october2$DATE <- as.character(strptime(file_list[2], "%m-%d")) 
october3$DATE <- as.character(strptime(file_list[3], "%m-%d")) 
october4$DATE <- as.character(strptime(file_list[4], "%m-%d")) 
october5$DATE <- as.character(strptime(file_list[5], "%m-%d")) 
october6$DATE <- as.character(strptime(file_list[6], "%m-%d")) 
october7$DATE <- as.character(strptime(file_list[7], "%m-%d")) 
october8$DATE <- as.character(strptime(file_list[8], "%m-%d")) 
october9$DATE <- as.character(strptime(file_list[9], "%m-%d")) 
october10$DATE <- as.character(strptime(file_list[10], "%m-%d")) 
october11$DATE <- as.character(strptime(file_list[11], "%m-%d")) 
october12$DATE <- as.character(strptime(file_list[12], "%m-%d")) 
october13$DATE <- as.character(strptime(file_list[13], "%m-%d")) 
october14$DATE <- as.character(strptime(file_list[14], "%m-%d")) 
october15$DATE <- as.character(strptime(file_list[15], "%m-%d")) 
october16$DATE <- as.character(strptime(file_list[16], "%m-%d")) 
october17$DATE <- as.character(strptime(file_list[17], "%m-%d")) 
october18$DATE <- as.character(strptime(file_list[18], "%m-%d")) 
october19$DATE <- as.character(strptime(file_list[19], "%m-%d")) 


october2015 <- rbind(october1, october2, october3, october4, october5, 
                       october6, october7, october8, october9, october10, 
                       october11, october12, october13, october14, october15, october16, 
                       october17, october18, october19)
october2015 <- filter(october2015, Driver != "Totals:")
rm(october1, october2, october3, october4, october5, 
   october6, october7, october8, october9, october10, 
   october11, october12, october13, october14, october15, october16, october17, october18, october19)
#View(october2015)
...
# append the months below to file from above
print("THIS PART IS FOR november 2015")
path <- "//majorbrands.com/STLcommon/Daily Report/2015/NOV"
setwd(path)


file_list <- list.files() 
file_list <- file_list[3:19]
length(file_list)
file_list
...
november1$DATE <- as.character(strptime(file_list[1], "%m-%d")) 
november2$DATE <- as.character(strptime(file_list[2], "%m-%d")) 
november3$DATE <- as.character(strptime(file_list[3], "%m-%d")) 
november4$DATE <- as.character(strptime(file_list[4], "%m-%d")) 
november5$DATE <- as.character(strptime(file_list[5], "%m-%d")) 
november6$DATE <- as.character(strptime(file_list[6], "%m-%d")) 
november7$DATE <- as.character(strptime(file_list[7], "%m-%d")) 
november8$DATE <- as.character(strptime(file_list[8], "%m-%d")) 
november9$DATE <- as.character(strptime(file_list[9], "%m-%d")) 
november10$DATE <- as.character(strptime(file_list[10], "%m-%d")) 
november11$DATE <- as.character(strptime(file_list[11], "%m-%d")) 
november12$DATE <- as.character(strptime(file_list[12], "%m-%d")) 
november13$DATE <- as.character(strptime(file_list[13], "%m-%d")) 
november14$DATE <- as.character(strptime(file_list[14], "%m-%d")) 
november15$DATE <- as.character(strptime(file_list[15], "%m-%d")) 
november16$DATE <- as.character(strptime(file_list[16], "%m-%d")) 
november17$DATE <- as.character(strptime(file_list[17], "%m-%d")) 


november2015 <- rbind(november1, november2, november3, november4, november5, 
                     november6, november7, november8, november9, november10, 
                     november11, november12, november13, november14, november15, november16, 
                     november17)
november2015 <- filter(november2015, Driver != "Totals:")
rm(november1, november2, november3, november4, november5, 
   november6, november7, november8, november9, november10, 
   november11, november12, november13, november14, november15, november16, november17)
#View(november2015)
...
## COMPILE AND SAVE BACKUP

compiled2015 <- rbind(january2015, february2015, march2015, april2015,
                      may2015, june2015, july2015, august2015,
                      september2015, october2015, november2015)

forCarrie <- compiled2015[,c('DATE', 'Driver', 'Stops', 'Truck.', 'LOC', 'total.cases', 'TTL.CS.STL', 'TTL.CS.COL', 
                             'TTL.CS.Cape', 'Cs', 'Btls', 'Driver.', 'Ttl.Hrs', 'Ttl.Mi', 'STL.Trucks', 
                             'CAPE.Trucks', 'RTE')]
forCarrie <- arrange(forCarrie, DATE)


setwd("C:/Users/pmwash/Desktop/R_Files/Data Backup")
write.csv(forCarrie, 'budget_for_carrie_nov2015.csv')




####
print('Aggregate daily number of trucks and the daily number of cases for STL -> COL or CAPE')

col <- filter(forCarrie, LOC == 'COL')
cape <- filter(forCarrie, Truck. == 'CWHSE')

colCases <- aggregate(total.cases ~ DATE, data=col, FUN=sum)
names(colCases) <- c('Date', 'Total.Cases.Columbia.2015')
csCol <- colCases$Total.Cases.Columbia.2015
colCases$Trucks.To.Columbia <- round(csCol / 1200, 1)


capeCases <- aggregate(total.cases ~ DATE, data=cape, FUN=sum)
names(capeCases) <- c('Date', 'Total.Cases.Cape.2015')
capeTrucks <- aggregate(CAPE.Trucks ~ DATE, data=cape, FUN=sum)
names(capeTrucks) <- c('Date', 'Trucks.To.Cape')


daily <- merge(colCases, capeCases, by='Date')
daily <- merge(daily, capeTrucks, by='Date')

csCol <- daily$Total.Cases.Columbia.2015
csCape <- daily$Total.Cases.Cape.2015

daily$Projected.Cases.Columbia <- csCol * 1.04
daily$Projected.Cases.Cape <- csCape * 1.04

csCol16 <- daily$Projected.Cases.Columbia
csCape16 <- daily$Projected.Cases.Cape

daily$Projected.Trucks.Columbia <- round(csCol16 / 1200, 1)
daily$Projected.Trucks.Cape <- round(csCape16 / 1200, 1)


daily <- daily[, c('Date', 'Total.Cases.Columbia.2015', 'Projected.Cases.Columbia', 'Trucks.To.Columbia', 
                   'Projected.Trucks.Columbia', 'Total.Cases.Cape.2015', 'Projected.Cases.Cape', 
                   'Trucks.To.Cape', 'Projected.Trucks.Cape')]
