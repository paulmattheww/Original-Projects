...
library(chron)
library(lubridate)
januaryBeg <- as.Date("01/01/2016", "%m/%d/%Y")
januaryEnd <- as.Date("01/31/2016", "%m/%d/%Y")
...
january2016 <- numberProductionDays
january2016
...
library(chron)
library(lubridate)
februaryBeg <- as.Date("02/01/2016", "%m/%d/%Y")
februaryEnd <- as.Date("02/28/2016", "%m/%d/%Y")
...
february2016 <- numberProductionDays
february2016
...
library(chron)
library(lubridate)
marchBeg <- as.Date("03/01/2016", "%m/%d/%Y")
marchEnd <- as.Date("03/31/2016", "%m/%d/%Y")
...
march2016 <- numberProductionDays
march2016
...
library(chron)
library(lubridate)
aprilBeg <- as.Date("04/01/2016", "%m/%d/%Y")
aprilEnd <- as.Date("04/30/2016", "%m/%d/%Y")
...
april2016 <- numberProductionDays
april2016
...
library(chron)
library(lubridate)
mayBeg <- as.Date("05/01/2016", "%m/%d/%Y")
mayEnd <- as.Date("05/31/2016", "%m/%d/%Y")
...
library(chron)
library(lubridate)
juneBeg <- as.Date("06/01/2016", "%m/%d/%Y")
juneEnd <- as.Date("06/30/2016", "%m/%d/%Y")
...
library(chron)
library(lubridate)
julyBeg <- as.Date("07/01/2016", "%m/%d/%Y")
julyEnd <- as.Date("07/31/2016", "%m/%d/%Y")
...
library(chron)
library(lubridate)
augustBeg <- as.Date("08/01/2016", "%m/%d/%Y")
augustEnd <- as.Date("08/31/2016", "%m/%d/%Y")
...
august2016 <- numberProductionDays
august2016
...
library(lubridate)
library(chron)
septemberBeg <- as.Date("09/01/2016", "%m/%d/%Y")
septemberEnd <- as.Date("09/30/2016", "%m/%d/%Y")
...
september2016 <- numberProductionDays
september2016
...
library(lubridate)
library(chron)
octoberBeg <- as.Date("10/01/2016", "%m/%d/%Y")
octoberEnd <- as.Date("10/31/2016", "%m/%d/%Y")
...
october2016 <- numberProductionDays
october2016
...
library(chron)
library(lubridate)
novemberBeg <- as.Date("11/01/2016", "%m/%d/%Y")
novemberEnd <- as.Date("11/30/2016", "%m/%d/%Y")
...
november2016 <- numberProductionDays
november2016
...
library(chron)
library(lubridate)
decemberBeg <- as.Date("12/01/2016", "%m/%d/%Y")
decemberEnd <- as.Date("12/31/2016", "%m/%d/%Y")
...
december2016 <- numberProductionDays
december2016
...
months <- c("January", "February", "March", "April", "May", "June", 
            "July", "August", "September", "October", "November", "December")
prodDays <- c(january2016, february2016, march2016, april2016, may2016, june2016,
              july2016, august2016, september2016, october2016, november2016, december2016)
productionDays2016 <- as.data.frame(cbind(months, prodDays))

production.history <- merge(productionDays2014, productionDays2016, by="months")
names(production.history) <- c("Month", "Production.Days.2014", "Production.Days.2016")
production.history$Month <- factor(production.history$Month, 
                                   levels=c("January", "February", "March", "April", "May", "June", 
                                            "July", "August", "September", "October", "November", "December"))
production.history <- production.history[order(production.history$Month),]
