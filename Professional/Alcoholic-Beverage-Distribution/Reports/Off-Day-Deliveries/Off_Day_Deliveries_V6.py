...
def write_offday_report_to_excel(summaryPercentages, high_level_summary, summary, slspplSummary, by_customer, by_day, need_delivery_days, 
    ...
    summary_tab.set_column('B:B',24.2)
    summary_tab.set_column('C:C',18.8)
    summary_tab.set_column('D:D',15.6)
    summary_tab.set_column('E:E',23)
    summary_tab.set_column('F:F',17.2, format_thousands)
    summary_tab.set_column('G:G',23.86)
    ...
    salespersonTab.set_column('A:A',10.57)
    salespersonTab.set_column('B:B',12.86)
    salespersonTab.set_column('C:C',22.71)
    salespersonTab.set_column('D:D',30.29)
    salespersonTab.set_column('E:E',24.00)
    salespersonTab.set_column('F:H',23, format_percent)    
    salespersonTab.set_column('I:M',23, format_thousands)    
