...
off_day_deliveries = function(deliveries, weeklookup) {
  library(lubridate)
  library(dplyr)
  library(stringr)
  source('C:/Users/pmwash/Desktop/R_files/Data Input/Helper.R')
  ...
  # d$Year = year(d$Date)
  # 
  # new = d$Customer.Setup
  # now_m = month(d$Month)
  # now_y = d$Year
  # 
  # setup_monthx = str_pad(as.character(d$Customer.Setup), 4, pad='0')
  # setup_monthx = month(as.numeric(substrLeft(setup_monthx, 2)))
  # sx = substrRight(as.character(d$Customer.Setup), 2)
  # this_centuryx = as.numeric(sx) < 20
  # setup_yearx = ifelse(this_centuryx == TRUE, 
  #                      as.numeric(as.character(paste0("20", sx))), 
  #                      as.numeric(as.character(paste0("19", sx))))
...
# pre_processed = read.csv('C:/Users/pmwash/Desktop/R_files/Data Input/Input Files for Reports/Off-Day Deliveries/T_Off-Day Deliveries.csv', header=TRUE)
# head(pre_processed)
