...
print('Read in KC data; do not change column headers')
breaks = read.csv("C:/Users/pmwash/Desktop/R_Files/Data Input/Input Files for Reports/Breakage/KC/PWBREAKAGE_KC.csv", header=TRUE) 
sales = read.csv('C:/Users/pmwash/Desktop/R_Files/Data Input/Input Files for Reports/Breakage/KC/sales_history_for_breakage_report_kc.csv', header=TRUE) # ensure it is for correct house
supplier = read.csv('C:/Users/pmwash/Desktop/R_Files/Data Input/Input Files for Reports/Breakage/KC/suppbreaka_kc.csv', header=TRUE)
supplier_history = read.csv('C:/Users/pmwash/Desktop/R_Files/Data Input/Input Files for Reports/Breakage/KC/supplier_history_for_breakage_kc.csv', header=TRUE) # n eed to append 
...
pre_process_breaks = function(breaks) {
  ...
  dat = as400Date(b$X.RDATE)
  b$CASES = round(b$X.RCASE + (b$X.RBOTT / b$X.RQPC), 2)
  b$MONTH = paste0(substrLeft(dat, 4), '-', substrLeft(substrRight(dat, 5), 2))
  b$DATE = dat 
  b
}
