...
Currently two metrics that were requested are not available. 
  ...
  - On-Time completion of job: The field in PostR is unreliable as of now. It defaults to 2 weeks, and is not always updated. If some sort of guidelines are issued to this regard
  - Number of "rush" jobs: The "rush" field is not passed from PostR to Diver in the raw model. When this field is passed to Diver the metric will be added.
