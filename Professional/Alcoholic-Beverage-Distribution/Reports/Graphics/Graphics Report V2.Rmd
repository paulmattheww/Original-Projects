...
graphics_posterIDs = c('MUELLER, RACHEL (86907)','RIEHLMAN, BRITTANY (86932)','WILHOIT, KATIE (86923)') ## need Paige
...
Pipeline is displayed by Designer and at the aggregate level.
...
The data & figures below considers *only projects that have been finished this year* only. Price and turnaround are shown as averages, while Jobs and Job Items are generated using a "count unique" function.
