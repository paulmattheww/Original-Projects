...
## YTD Redesigns
A Job is marked as having experienced a Redesign in the even tthat the "AwaitingArtworkRedesign" text was discovered in the text field in PostER that marks each stage of the Job. It is important to note that there are considerably more Print jobs than there are Accessory jobs. The plot below shows the average turnaround for Print jobs in Blue while showing the same for Accessory jobs in Red.
...
```{r viz_redesigns_accessoryvprint}
