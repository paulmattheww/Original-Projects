...
pct_chg = function(new, old) round(((new-old)/old)*100, 1)
...
### Trailing 3 Months, Month-to-Date
...
kickedoff_byhouse = aggregate(POSTERJob.ID ~ KickoffYear + KickoffMonth + Company, data=df_ytd_thislast, FUN=len_unique)
...
aggregate(POSTERJob.ID ~ Year + KickoffMonth + Company, data=trailing_3, FUN=len_unique)
```



### YTD Jobs & Percent of Profit
