...
# getRedesigns = function(df_thisyr_lastyr){
...
#   redesigns = df_thisyr_lastyr[, redesign_colz]
...
# }
# 
# redesigns = getRedesigns(df_thisyr_lastyr)
...
get_turnaround_summary = function(df, col, active_designers){
  ...
  turnaround_summary = aggregate(df[,'JobTurnaround'] ~ df[,'Designer'] + df[,col], FUN=function(x) mean(x, na.rm=T))
  turnaround_summary = data.frame(setNames(turnaround_summary, c('Designer', as.character(col), 'JobTurnaround')))
...
plot_redesigns(get_turnaround_summary(df_thisyr_lastyr, 'Menu', active_designers), 
               'Menu', title='Turnaround: Menu vs. Non-Menus')
plot_redesigns(get_turnaround_summary(df_thisyr_lastyr, 'Redesign', active_designers), 
               'Redesign', title='Turnaround: Redesigns vs. Non-Redesigns')
plot_redesigns(get_turnaround_summary(df_thisyr_lastyr, 'Reprint', active_designers), 
               'Reprint', title='Turnaround: Reprints vs. Non-Reprints')
plot_redesigns(get_turnaround_summary(df_thisyr_lastyr, 'Warehouse', active_designers), 
