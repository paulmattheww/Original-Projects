...
df$JobAbandoned = grepl('zj$', df$POSTER.JOB.STATUS)
...
df$InPipeline = (strtd==T) & (finsd==F)#df$POSTERJob.ID %in% inppp

writePipelineToCsv = function(df){
  ...
  colsToCheck = c('POSTER.Designer','POSTERJob.ID','POSTER.JOB.STATUS','Salesperson','Customer','Company','POSTER.Price',
                  'Incomplete','JobInLimbo','AssembledandShipped')
