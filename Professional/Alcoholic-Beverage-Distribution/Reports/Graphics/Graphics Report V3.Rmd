...
## Count up Number of Artwork redesigns
# redesignColumns = names(df)
# redesignColumns = redesignColumns[grepl('ArtworkRedesign', redesignColumns)]
# redesignCounts = !is.na(df[,redesignColumns])
# df$RedesignCounts = rowSums(redesignCounts, na.rm=T)

## Count up Number of Times Brands Entered
# brandsEnteredColumns = names(df)
# brandsEnteredColumns = brandsEnteredColumns[grepl('BrandMentionsEntered', brandsEnteredColumns)]
# brandsEnteredCounts = !is.na(df[,brandsEnteredColumns])
# df$TimesBrandsEntered = rowSums(brandsEnteredCounts, na.rm=T)
...
## Checking for bugs
# x_df = df_thisyr_lastyr[df_thisyr_lastyr$InPipeline==T,]
# tail(x_df)
