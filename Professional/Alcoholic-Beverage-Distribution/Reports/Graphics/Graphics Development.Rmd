...
At present, only jobs that have been shipped are shown in the data below. Data for the current pipeline is above.
...
There exist Jobs that were started long ago (i.e. last year or the year before) that still do not have a finish date; these were filtered out. 
...
#############CHANGE IF NEED BE, ALL 3 YEARS IS CONSERVATIVE
last2yrs = (lubridate::year(job_history$Incomplete) %in% c(this_yr,last_yr,twoyrsago))###
