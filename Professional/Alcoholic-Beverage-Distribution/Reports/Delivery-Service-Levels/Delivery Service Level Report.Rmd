...
z$StopArrival = paste0(as.character(z$Stop), z$ExpectedArrival)
z$DateRouteIdentifierCustomer = paste0(as.character(z$Date), ' ', z$RouteIdentifier, ' ', z$Customer)
...
TIMELINE_PLOT = gvisTimeline(data=z,
                        rowlabel = 'DateRouteIdentifierCustomer',
                        barlabel = 'StopArrival',
                        start = 'Start',
                        end = 'End',
                        options=options)
plot(TIMELINE_PLOT)
