...
print('Locations from Bob Kloeppinger')
...
make_labels = function(upc, locsBob, locations) {
  ...
  print('Columns in BOTUPC must be formatted as numbers with no decimals.')
  options(scipen=999)
  ...
  print('Output file produced. Format Last.3 column and input into Wasp for label production')
}
